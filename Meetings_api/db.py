...
def insert_sessions(conn):
    ...
    cur.execute("""
        INSERT OR IGNORE INTO Session (Id, ClientId, StartTime, EndTime, Description, DayOfWeek) VALUES
        (1, 1, "09:00", "10:00", "Trening poranny", 1),
        (2, 2, "11:00", "12:00", "Sesja indywidualna", 2),
        (3, 3, "14:30", "15:30", "Trening siłowy", 3),
        (4, 1, "16:00", "17:00", "Cardio", 4),
        (5, 4, "18:15", "19:00", "Stretching", 5);
    """)
